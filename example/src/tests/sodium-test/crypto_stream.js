...
module.exports = function (sodium) {
  ...
  it('crypto_stream_xor_instance', function () {
    var message = Buffer.from('Hello, world!')
    var nonce = random(sodium.crypto_stream_NONCEBYTES)
    var key = random(sodium.crypto_stream_KEYBYTES)
  ...
  it('crypto_stream_xor_instance with empty buffers', function () {
    var message = Buffer.from('Hello, world!')
    var nonce = random(sodium.crypto_stream_NONCEBYTES)
    var key = random(sodium.crypto_stream_KEYBYTES)
  ...
  it('crypto_stream_xor_instance long stream', function () {
    var nonce = random(sodium.crypto_stream_NONCEBYTES)
    var key = random(sodium.crypto_stream_KEYBYTES)
  ...
  it('crypto_stream_xor_instance long stream (random chunks)', function () {
    var nonce = random(sodium.crypto_stream_NONCEBYTES)
    var key = random(sodium.crypto_stream_KEYBYTES)
  ...
  it('crypto_stream_xor_instance long stream (random chunks) with empty buffers', function () {
    var nonce = random(sodium.crypto_stream_NONCEBYTES)
    var key = random(sodium.crypto_stream_KEYBYTES)
  ...
  it('crypto_stream_chacha20', function () {
    var buf = Buffer.alloc(50)
  ...
  it('crypto_stream_chacha20_xor', function () {
    var message = Buffer.from('Hello, World!')
    var nonce = random(sodium.crypto_stream_chacha20_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_KEYBYTES)
  ...
  it('crypto_stream_chacha20_xor_instance', function () {
    var message = Buffer.from('Hello, world!')
    var nonce = random(sodium.crypto_stream_chacha20_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_KEYBYTES)
  ...
  it('crypto_stream_chacha20_xor_instance with empty buffers', function () {
    var message = Buffer.from('Hello, world!')
    var nonce = random(sodium.crypto_stream_chacha20_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_KEYBYTES)
  ...
  it('crypto_stream_chacha20_xor_instance long stream', function () {
    var nonce = random(sodium.crypto_stream_chacha20_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_KEYBYTES)
  ...
  it('crypto_stream_chacha20_xor_instance long stream (random chunks)', function () {
    var nonce = random(sodium.crypto_stream_chacha20_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_KEYBYTES)
  ...
  it('crypto_stream_chacha20_xor_instance long stream (random chunks) with empty buffers', function () {
    var nonce = random(sodium.crypto_stream_chacha20_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_KEYBYTES)
  ...
  it('crypto_stream_chacha20_ietf', function () {
    var buf = Buffer.alloc(50)
  ...
  it('crypto_stream_chacha20_ietf_xor', function () {
    var message = Buffer.from('Hello, World!')
    var nonce = random(sodium.crypto_stream_chacha20_ietf_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_ietf_KEYBYTES)
  ...
  it('crypto_stream_chacha20_ietf_xor_instance', function () {
    var message = Buffer.from('Hello, world!')
    var nonce = random(sodium.crypto_stream_chacha20_ietf_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_ietf_KEYBYTES)
  ...
  it('crypto_stream_chacha20_ietf_xor_instance with empty buffers', function () {
    var message = Buffer.from('Hello, world!')
    var nonce = random(sodium.crypto_stream_chacha20_ietf_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_ietf_KEYBYTES)
  ...
  it('crypto_stream_chacha20_ietf_xor_instance long stream', function () {
    var nonce = random(sodium.crypto_stream_chacha20_ietf_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_ietf_KEYBYTES)
  ...
  it('crypto_stream_chacha20_ietf_xor_instance long stream (random chunks)', function () {
    var nonce = random(sodium.crypto_stream_chacha20_ietf_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_ietf_KEYBYTES)
  ...
  it('crypto_stream_chacha20_ietf_xor_instance long stream (random chunks) with empty buffers', function () {
    var nonce = random(sodium.crypto_stream_chacha20_ietf_NONCEBYTES)
    var key = random(sodium.crypto_stream_chacha20_ietf_KEYBYTES)
