...
module.exports = function (sodium) {
  it('crypto_sign_open fixtures', function () {
  ...
  it('crypto_sign fixtures', function () {
    var fixtures = require('./fixtures/crypto_sign.json')
  ...
  it('crypto_sign_verify_detached fixtures', function () {
    var fixtures = require('./fixtures/crypto_sign.json')
  ...
  it('crypto_sign_detached fixtures', function () {
    var fixtures = require('./fixtures/crypto_sign.json')
