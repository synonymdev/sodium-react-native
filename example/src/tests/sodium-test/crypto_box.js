...
module.exports = function (sodium) {
  it('crypto_box_keypair generate key-pair', function () {
  ...
  it('crypto_box_seal/crypto_box_seal_open self-decrypt', function () {
    var pubKey = Buffer.alloc(sodium.crypto_box_PUBLICKEYBYTES)
    var secret = Buffer.alloc(sodium.crypto_box_SECRETKEYBYTES)
  ...
  it('crypto_box_seal_open cross-decrypt', function () {
  ...
  it('crypto_box_seed_keypair', function () {
